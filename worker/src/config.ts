...
const envSchema = z.object({
    ...
    LLM_BACKUP_API_KEY: z.string().optional(),
    LLM_BACKUP_MODEL: z.string().optional(),
    LLM_BACKUP_MODELS: z.string().optional(),
    LLM_BACKUP_BASE_URL: z.string().default('https://openrouter.ai/api/v1'),
    LLM_PROVIDER_COOLDOWN_MS: z.coerce.number().default(300000),
