...
function AnalysesPage() {
  ...
  return (
    <>
                  ...
                  <table className="w-full border-collapse text-sm">
                    <thead>
                      <tr className="text-left text-[11px] uppercase tracking-wider text-(--sea-ink-soft)">
                        ...
                        <th className="hidden px-3 py-2.5 font-semibold md:table-cell">Verdict</th>
                    ...
                    <tbody>
                      {filtered.map((analysis) => (
                        ...
                        >
                          ...
                          <td className="hidden max-w-48 truncate px-3 py-2.5 font-mono text-xs text-(--sea-ink-soft) md:table-cell">
      ...
      {selected ? (
        <div className="fixed inset-0 z-50 flex justify-end" role="dialog" aria-modal="true" aria-label="Analysis details">
          ...
          <aside className="relative flex h-full w-full max-w-md flex-col overflow-hidden bg-(--surface-strong) shadow-2xl">
            <div className="flex items-center justify-between border-b border-(--line) px-5 py-4">
              <p className="m-0 flex items-center gap-2 text-sm font-bold text-(--sea-ink)">
                <Bot className="h-4 w-4 text-(--lagoon-deep)" aria-hidden="true" />
                {selected.analysisConfigName}
              </p>
              <button
                type="button"
