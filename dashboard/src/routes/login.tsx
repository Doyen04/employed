...
function LoginPage() {
    ...
    return (
        <main className="page-wrap flex justify-center px-4 pb-16 pt-20">
            <section className="island-shell rise-in w-full max-w-md rounded-4xl px-6 py-8 sm:px-10">
                <p className="island-kicker mb-2">Employed</p>
                <h1 className="display-title mb-1 text-3xl font-bold tracking-tight text-(--sea-ink)">
                    Sign in
                </h1>
                ...
                <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                    <label className="flex flex-col gap-1.5 text-sm font-semibold text-(--sea-ink)">
                        Password
                        <input
                            type="password"
                            value={password}
                    ...
                    <button
                        ...
                        className="rounded-full bg-[#ECB914] px-5 py-2.5 text-sm font-semibold text-[#4F3D35] transition hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-50"
                    >
